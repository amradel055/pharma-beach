    ...
    <div class="auth-form-side">
      <div class="auth-form-container">
        ...
        <form @submit.prevent="handleRegister" novalidate>
          ...
          <!-- Submit -->
          <button type="submit" class="auth-btn anim-item" style="--i: 6" :disabled="!isFormValid || loading">
        ...
        <!-- Login link -->
        <p class="switch-link anim-item" style="--i: 7">
          لديك حساب؟
...
const isFormValid = computed(
  () => isNameValid.value && isEmailValid.value && isPhoneValid.value && isPasswordValid.value,
)
